...
const CHRONOLOGY = [
  ...
  'stone-tools',
  'genus-homo',
  'out-of-africa-erectus',
  'acheulean-handaxes',
  'fire-control',
  'cooking-food-energy',
  'neanderthals-denisovans',
  'homo-sapiens',
  'coastal-foraging-sapiens',
  'symbolic-culture',
  'ochre-workshops',
  ...
  'sahul-colonization',
  'fire-stick-land-management',
  'upper-paleolithic-art',
  'tailored-clothing-needles',
  'dog-domestication',
  'ice-age-dwellings',
  ...
  'goat-sheep-herding',
  'permanent-villages',
  'independent-agriculture-centers',
  'yangtze-rice',
  'maize-domestication',
  ...
  'copper-metallurgy',
  'plough-and-traction',
  'copper-mining-specialists',
  'river-sailing',
  'wheel-and-transport',
  'first-cities-states',
  'writing-invention',
  'proto-cuneiform-accounting',
  'indus-urban-water',
  'pyramid-state-labor',
  'law-codes',
  ...
  'glassmaking',
  'iron-age',
  'roman-concrete-aqueducts',
  'paper-making-china',
  'silk-road-exchanges',
  'stirrup-cavalry',
  'zero-positional-numerals',
  'woodblock-printing',
  'islamic-golden-age',
  'gunpowder-weapons',
  'compass-navigation',
  ...
  'printing-press',
  'columbian-exchange',
  'lenses-microscope-telescope',
  'scientific-revolution',
  'atlantic-slave-trade-plantations',
  'fossil-fuel-coal',
  'steam-engine-watt',
  'industrial-revolution',
  'smallpox-vaccination',
  'railways-global-time',
  ...
  'transistor',
  'great-acceleration',
  'mass-vaccination-public-health',
  'dna-double-helix',
  'space-age',
...
const chronologyIndex = new Map(CHRONOLOGY.map((id, index) => [id, index]));
...
export const events = [
  ...
  .map((event) => {
    if (!chronologyIndex.has(event.id)) {
      throw new Error(`Missing chronology position for ${event.id}`);
    }
    return { ...event, order: chronologyIndex.get(event.id) * 100 };
  })
  .sort((a, b) => a.order - b.order);

export const expectedChronology = CHRONOLOGY;
